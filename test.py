    ...
    def start_linkedin(self, username, password) -> None:
        ...
        try:
            ...
            #     time.sleep()
              ...
              # Sleep for 5 minutes after logging in
...
if __name__ == '__main__':
    ...
    assert parameters['gmail_username'] is not None  # Assert Gmail username is provided
    assert parameters['gmail_password']
